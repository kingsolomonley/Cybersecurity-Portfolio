...
# The import_file did not return anything while the "allow_list" returns its content. 
...
# Yes, 192.168.97.225, 192.168.158.170 etc
...
# It makes it reuseable. It also make updating/changing smart, just a change to the function is needed. It make coding simple.
...
# Writing algorithm is intuitive and creative. It helps simplify the solution to a problem. Putting code in function make that code reuseable and easy to update. it makes coding smart.
